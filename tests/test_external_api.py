...
@pytest.fixture
def usd_transaction():
    return {"operationAmount": {"amount": "100.50", "currency": {"code": "USD", "name": "USD"}}}


@pytest.fixture
def eur_transaction():
    return {"operationAmount": {"amount": "50.00", "currency": {"code": "EUR", "name": "EUR"}}}


@pytest.fixture
def rub_transaction():
    return {"operationAmount": {"amount": "2000", "currency": {"code": "RUB", "name": "RUB"}}}
...
def test_api_failure(usd_transaction):
    ...
    with patch("src.external_api.API_KEY", "fake_key_123"):
